<template>
  <div>
    ...
    <b-container class="calender">
      <p class="paragraph">
        Hey Jane, bitte hinterlege hier deine Arbeitsdienste sowie private
        Abwesenheiten. Nur so wissen wir, wann du verfugbar bist und konnen
